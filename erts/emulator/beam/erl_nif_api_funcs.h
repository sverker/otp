...
ERL_NIF_API_FUNC_DECL(ERL_NIF_TERM, enif_unique_integer, (ErlNifEnv *env, int properties));
...
#  define enif_unique_integer ERL_NIF_API_FUNC_MACRO(enif_unique_integer)
