...
BIF_RETTYPE hipe_bifs_add_ref_2(BIF_ALIST_2)
{
    ...
    //SVERK not needed? caller_mfa = hipe_mfa_info_table_put_locked(caller.mod, caller.fun, caller.ari);
