...
% detected.
%
% * Konstantinos Sagonas and Kjell Winblad. Contention Adapting
%   Search Trees. In Proceedings of the Fourteenth International
%   Symposium on Parallel and Distributed Computing, Limassol, Cyprus,
%   July 2015.
